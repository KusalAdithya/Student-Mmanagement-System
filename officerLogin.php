                ...
                <div class="col-11 mt-3 mt-lg-5 mx-auto mb-3 p-2 div1">
                    <div class="row mt-4">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="logo"></div>
                            <div class="d-none d-md-block img3"></div>
                        </div>
                        <!-- logo -->
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="row justify-content-center p-2 my-auto mt-lg-5">
                                <div class="col-11 mt-5">
                                    <p class="text-center title1">Philip Neri College Academic Officer Login</p>
                                </div>
                                ...
                                <div class="col-5 d-grid mt-3 mb-3">
                                    <button class="btn btn-primary btn1" onclick="signInAO();">Sign In</button>
                                </div>
                            </div>
                        </div>
                        <!-- login -->
