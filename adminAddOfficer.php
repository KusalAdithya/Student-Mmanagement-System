                ...
                <div class="col-10 mx-auto mb-3 p-2 px-4 div3" id="load">
                    <div class="row mt-4 mb-4">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <h2 style="font-family: 'Ubuntu-Light'; font-weight: bold;">Register Academic officers</h2>
                                </div>
                        ...
                        <div class="col-10 mt-4 mx-auto">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-12 mb-3 ">
                                    ...
                                    <input type="number" class="form-control input2" id="OAdN" onclick="clearalert();" min="0" />
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-6">
                            ...
                            <div class="row ">
                                <div class="col-md-12 mb-3 ">
                                    ...
                                    <select class="form-select" style="border-radius: 10px;" id="selectGrade" onchange="clearalert();">
                                        <option value="0">Select a Grade</option>
                                        <?php
                                        $g = Database::search("SELECT * FROM `grade` ");
                                        while($g_r = $g->fetch_assoc()){
                                            ?>
                                            <option value="<?php echo $g_r["id"] ?>"><?php echo $g_r["name"] ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="row mt-4 text-center">
                                <div class="col-10 col-md-5 mx-auto d-grid">
                                    <button class="btn btn-primary btn2" onclick="adminAddOfficer();">Register & Send Vervication Code</button>
                                </div>
                            </div>
